...
const GigRightSideBar = () => {
    return (
        <>
            <div className='fixed flex flex-col gap-y-4 bg-navyblue'>
                <div className='border-b border-gray-600 m-2.5  flex justify-end w-[90%] mx-auto'>
                    {/* <SubmitButton
                      ...
                      <button type="submit" className='py-2 px-5 bg-beige hover:bg-beige rounded-full text-navyblue text-center hover:font-bold text-sm font-extrabold font-nunito-sans items-center mb-2'>Services Dashboard</button>  
                </div>
                <GigSearchBar />
                <div className='border border-gray-700 rounded-lg p-4 flex flex-col space-y-1 w-[90%] mx-auto bg-[#04071b] text-gray-400 '>
                    ...
                    <SubmitButton
                        ...
                        text={'Subscribe'}
                        style='py-2 px-4 bg-gray-300 md:text-md lg:text-md text-primary  hover:cursor-pointer hover:font-semibold hover:text-white hover:bg-primary md:rounded-full' />
                </div>
                <div className='border border-gray-600 rounded-lg p-3 flex flex-col space-y-1 w-[90%] mx-auto bg-[#04071b] text-gray-400 '>
                ...
                <div className='border border-gray-600 rounded-lg p-3 flex flex-col space-y-1 w-[90%] mx-auto bg-[#04071b] text-gray-400 mb-3.5'>
...
export default GigRightSideBar